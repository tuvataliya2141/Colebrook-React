                ...
                <div className="header-action-2">
                    ...
                    <div className="header-action-icon-2">
                        ...
                        <div className="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                            <ul>
                            <li>
                                <Link to="/"><i className="fi fi-rs-user mr-10" />My Account</Link>
                            </li>
                            <li>
                                <Link to="/Register"><i className="fi fi-rs-heart mr-10" />Register</Link>
                            </li>
                            <li>
                                <Link to="/Login"><i className="fi fi-rs-settings-sliders mr-10" />Login</Link>
                            </li>
                            <li>
                                <Link to="/"><i className="fi fi-rs-sign-out mr-10" />Sign out</Link>
                            </li>
                            </ul>
                        </div>
                    </div>
